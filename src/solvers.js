...
window.findNRooksSolution = function(n) {
    ...
    var findSolution = function(board, row, n) {
    ...
    solution = findSolution(board, 0, n)

    console.log('Single solution for ' + n + ' rooks:', JSON.stringify(solution));
    return solution;
};

// return the number of nxn chessboards that exist, with n rooks placed such that none of them can 
// attack each other
